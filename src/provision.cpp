                          ...
                          int32_t event_id, void *event_data)
{
    ...
    if (event_base == WIFI_PROV_EVENT)
    {
        ...
        case WIFI_PROV_CRED_FAIL:
        {
            ...
            {
                printf("Failed to connect with provisioned AP, reseting provisioned credentials\n");
...
void prov_main(void)
{
    ...
    if (!provisioned)
    {
         ...
         */
        wifi_prov_mgr_endpoint_create("sensorName");
        wifi_prov_mgr_endpoint_create("sensorLocation");
         ...
         */
        wifi_prov_mgr_endpoint_register("sensorName", custom_prov_data_handler, NULL);
        wifi_prov_mgr_endpoint_register("sensorLocation", custom_prov_data_handler, NULL);
    ...
    {
        printf("Already provisioned, starting Wi-Fi STA\n");
